...
The 2026-06-08 model/risk-control pass added sample-gated forecast bias correction, dynamic sigma widening, adjacent-hour/same-day directional caps for hourly temp, expensive BUY_NO guards for rain/bands, stale-shadow alerts, counterfactual skipped-trade audit tooling, and disabled bulky shadow `orderbook_json` persistence by default for Supabase free-tier storage. These are still research controls; they do **not** enable live trading or prove profitability.
